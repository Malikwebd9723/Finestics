...
const SubscriptionScreen = () => {
    ...
    const submitSelectedPlan = async () => {
        ...
        try {
            setSubmitting(true);
            await apiRequest('/onboarding/payment-plan', 'POST', { selectedPlanId: selected });
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                {plans.map((plan) => (
                    ...
                    >
                        ...
                        {/* Description */}
                        {plan.description && (
                            <Text className="mt-3 italic text-sm" style={{ color: colors.text }}>
                                {plan.description}
                            </Text>
                        )}
                    </TouchableOpacity>
                ...
                {/* Footer Buttons */}
                <View className="mt-10 mb-10 flex-row justify-between">
                    <TouchableOpacity
                        onPress={onBack}
